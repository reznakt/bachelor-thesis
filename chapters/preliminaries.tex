...
\begin{itemize}
    ...
    \item \texttt{<rect>}, \texttt{<circle>}, \texttt{<ellipse>}, and others: elementary geometric shapes,
...
\begin{itemize}
    ...
    \item $\operatorname{rotate}\left(\alpha, c_x, c_y\right)$: counter-clockwise rotation by $\alpha$ degrees around the point $\point{c_x, c_y}$,
