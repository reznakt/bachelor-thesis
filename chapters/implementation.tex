...
The library is designed to comply with the \gls{svg}~1.1 specification~\cite{svg11}, supporting all elements and attributes defined therein. Furthermore, we have incorporated various advantageous features from \gls{svg}~2~\cite{svg2} and the \gls{svg}~2 Editor's Draft~\cite{svg2-draft}, such as:
\begin{itemize}
...
\begin{minted}{python}
    t = Translate(1, 2)
    m = t.to_matrix()  # Matrix(1, 0, 0, 1, 1, 2)
\end{minted}
