...
\begin{proof}
    ...
    \[     
        T\left(\gamma(0)\right) = A\gamma(0) + \vec{b} = A\gamma(1) + \vec{b} = T\left(\gamma(1)\right)\text{.}
    \]
    ...
    \[
        \underbrace{T^{-1}\left(T\left(\gamma(0)\right)\right)}_{\gamma(0)} = CT\left(\gamma(0)\right) + \vec{d} = CT\left(\gamma(1)\right) + \vec{d} = \underbrace{T^{-1}\left(T\left(\gamma(1)\right)\right)}_{\gamma(1)}\text{,}
    \]
    from which we see that $\gamma(0) = \gamma(1)$, and therefore $\gamma$ is also closed. 
